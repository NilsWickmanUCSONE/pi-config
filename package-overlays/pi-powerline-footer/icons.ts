...
export const NERD_ICONS: IconSet = {
  ...
  model: "󱜙",      // nf-md-robot_happy (U+F1719)
  thinking: "󰧑",   // nf-md-brain (U+F09D1)
...
export const ASCII_ICONS: IconSet = {
  pi: "π",
  model: "󱜙",      // nf-md-robot_happy (U+F1719, force requested icon even without Nerd Font auto-detect)
  thinking: "󰧑",   // nf-md-brain (U+F09D1, force requested icon even without Nerd Font auto-detect)
  folder: "📁",
  branch: "⎇",
  git: "⎇",
  tokens: "⊛",
